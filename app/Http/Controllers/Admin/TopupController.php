...
class TopupController extends Controller
{
   use PingServer;
    ...
    {
        // Whitelist allowed adjustment targets — legacy investment columns
        // (Bonus / Profit / Ref_Bonus) are no longer supported from the admin UI.
        if (!in_array($request->input('type'), ['balance', 'Deposit'], true)) {
            return redirect()->back()->with('message', 'Invalid adjustment target.');
        }
