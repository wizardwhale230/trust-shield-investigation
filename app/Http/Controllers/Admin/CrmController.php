...
class CrmController extends Controller
{
    public function addtask(Request $request)
    {
        ...
        SafeMail::send(fn() => Mail::to($mailduser->email)->send(new NewNotification($message, $subject, $mailduser->firstName)), ['admin_id' => $mailduser->id]);
    ...
    public function assign(Request $request)
    {
        ...
        SafeMail::send(fn() => Mail::to($mailduser->email)->send(new NewNotification($message, $subject, $name)), ['admin_id' => $mailduser->id]);
