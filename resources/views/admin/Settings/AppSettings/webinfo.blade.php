    ...
    <div class="col-12">
        <form method="post" action="{{ route('updatewebinfo') }}" id="appinfoform" enctype="multipart/form-data">
            ...
            <div class=" form-row">
                ...
                <div class="form-group col-md-6">
                    <h5 class="text-{{ $text }}">Office Phone Number</h5>
                    <input name="office_phone" class="form-control" type="text"
                        value="{{ $settings->office_phone }}" placeholder="e.g. +1 (800) 555-0100">
                </div>
                <div class="form-group col-md-6">
                    <h5 class="text-{{ $text }}">Office Address</h5>
                    <input name="office_address" class="form-control" type="text"
                        value="{{ $settings->office_address }}" placeholder="e.g. 123 Main Street, New York, NY 10001">
                </div>
                 <div class="form-group col-md-6">
