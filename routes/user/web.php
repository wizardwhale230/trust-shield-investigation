...
use App\Http\Controllers\User\FeeRequestController;
...
Route::middleware(['auth:sanctum', 'verified'])->prefix('dashboard')->group(function () {
    ...
    Route::middleware('complete.kyc')->group(function () {
        ...
        Route::name('user.')->group(function () {
            ...
            Route::get('cases/{fraudCase}', [CaseController::class, 'show'])->name('cases.show');
            Route::post('cases/{fraudCase}/upload', [CaseController::class, 'uploadDocument'])->name('cases.upload');
            Route::get('cases/{fraudCase}/documents/{document}/download', [CaseController::class, 'downloadDocument'])->name('cases.document.download');
            Route::get('cases/{fraudCase}/member', [CaseController::class, 'assignedMember'])->name('cases.member');
            Route::get('fee-requests', [FeeRequestController::class, 'index'])->name('fee-requests');
        });
        ...
        // --- Disabled: Investment features removed for recovery platform ---
        ...
        Route::get('payments/{id}/receipt', [DepositController::class, 'paymentReceipt'])->name('payment.receipt');
        ...
        // --- Disabled: Subscription trading removed ---
        ...
        // --- Disabled: Membership & courses removed ---
        // Route::name('user.')->group(function () {
